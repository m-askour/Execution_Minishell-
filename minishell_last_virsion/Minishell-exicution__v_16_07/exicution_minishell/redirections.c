...
/*   Updated: 2025/07/16 23:29:11 by maskour          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	apply_input_redirection(int last_in_fd, int orig_stdin,
				int orig_stdout)
{
	if (last_in_fd == -1)
		return (0);
...
static int	apply_output_redirection(int last_out_fd,
